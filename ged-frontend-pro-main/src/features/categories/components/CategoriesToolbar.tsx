...
type Props = {
  ...
  onActiveFilterChange: (v: CategoryActiveFilter) => void;
  onReset: () => void;
  total: number;
};
...
export function CategoriesToolbar({
  ...
  const handleRefresh = async () => {
    ...
    try {
      ...
      toast.success("Catégories rechargées");
    } catch (e) {
        ...
        <div className="p-4 bg-background">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              ...
              <Select value={activeFilter} onValueChange={(v) => onActiveFilterChange(v as CategoryActiveFilter)}>
                <SelectTrigger>
