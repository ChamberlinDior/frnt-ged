...
export function DepartmentsHeader({ total, activeCount, inactiveCount, onNew }: Props) {
  const cards = [
    {
      label: "Total",
      value: total,
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0">
          ...
          <p className="text-sm text-muted-foreground mt-2 max-w-2xl leading-relaxed">
            Gérez les départements pour organiser les documents par services ou unités.
          </p>
        </div>
